...
vim.g.colorcolumn = "100" -- Highlight column 100 to indicate line length limit
...
vim.opt.colorcolumn = vim.g.colorcolumn -- Vertical line at right edge
...
vim.opt.winborder = "single" -- Thin border for all floating windows
